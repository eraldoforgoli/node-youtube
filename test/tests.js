...
describe("Testing main features (crop, snapshot, GIF, download)", function () {
  describe("Testing snapshots", function () {
    ...
    beforeEach(function (done) {
      this.timeout(180000);
      youtube.snapshot("0:02", filePath).then(done);
    });
  ...
  describe("Testing GIFs taking", function () {
    ...
    beforeEach(function (done) {
      this.timeout(180000);
      youtube.gif("0:02", "0:05", filePath).then(done);
    });
  ...
  describe("Testing crop", function () {
    ...
    beforeEach(function (done) {
      this.timeout(180000);
      youtube.crop("0:00", "0:05", filePath).then(done);
    });
  ...
  describe("Testing download", function () {
    ...
    beforeEach(function (done) {
      this.timeout(180000);
      youtube.download(filePath).then(done);
    });
